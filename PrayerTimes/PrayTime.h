...
//---------------------- Time-Zone Functions -----------------------
@property (NS_NONATOMIC_IOSONLY, getter=getTimeZone, readonly) double timeZone;
@property (NS_NONATOMIC_IOSONLY, getter=getBaseTimeZone, readonly) double baseTimeZone;
@property (NS_NONATOMIC_IOSONLY, readonly) double detectDaylightSaving;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSMutableArray *computeDayTimes;
